...
infile = pd.read_csv('./data/cleaned_routes.csv')
cleaned_routes = pd.DataFrame(infile)
...
ratings = pd.read_csv('./data/select_ratings.csv')
...
def add_multi_routes(excursion_length, seed_route, max_routes=10):
    ...
    #trip_options.to_csv('./nick-dash-app/data/testing_options.csv')
